...
enum upipe_grid_in_command {
    ...
    UPIPE_GRID_IN_GET_LATENCY_FRAMES,
    /** set the internal latency in frames (unsigned) */
    UPIPE_GRID_IN_SET_LATENCY_FRAMES,
};
 ...
 * @return an error code
 */
static inline int upipe_grid_in_get_latency_frames(struct upipe *upipe,
                                                   unsigned *nb)
{
    return upipe_control(upipe, UPIPE_GRID_IN_GET_LATENCY_FRAMES,
 ...
 * @return an error code
 */
static inline int upipe_grid_in_set_latency_frames(struct upipe *upipe,
                                                   unsigned nb)
{
    return upipe_control(upipe, UPIPE_GRID_IN_SET_LATENCY_FRAMES,
                         UPIPE_GRID_IN_SIGNATURE, nb);
}
