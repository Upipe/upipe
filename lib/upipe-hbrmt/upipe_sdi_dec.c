...
#endif
    {
        upipe_sdi_dec->uyvy_to_v210 = upipe_uyvy_to_v210_aligned_ssse3;
        upipe_sdi_dec->uyvy_to_planar_8 = upipe_uyvy_to_planar_8_aligned_ssse3;
        upipe_sdi_dec->uyvy_to_planar_10 = upipe_uyvy_to_planar_10_aligned_ssse3;
    }

    if (__builtin_cpu_supports("avx")) {
        upipe_sdi_dec->uyvy_to_v210 = upipe_uyvy_to_v210_aligned_avx;
        upipe_sdi_dec->uyvy_to_planar_8 = upipe_uyvy_to_planar_8_aligned_avx;
        upipe_sdi_dec->uyvy_to_planar_10 = upipe_uyvy_to_planar_10_aligned_avx;
    }

    if (__builtin_cpu_supports("avx2")) {
        upipe_sdi_dec->uyvy_to_v210 = upipe_uyvy_to_v210_aligned_avx2;
        upipe_sdi_dec->uyvy_to_planar_8 = upipe_uyvy_to_planar_8_aligned_avx2;
        upipe_sdi_dec->uyvy_to_planar_10 = upipe_uyvy_to_planar_10_aligned_avx2;
    }
#endif
