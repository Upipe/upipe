...
void upipe_planar_to_uyvy_8_sse2(uint16_t *dst, const uint8_t *y, const uint8_t *u, const uint8_t *v, const int64_t width);
...
void upipe_v210_to_uyvy_aligned_ssse3(const uint32_t *src, uint16_t *uyvy, int64_t width);
void upipe_v210_to_uyvy_aligned_avx  (const uint32_t *src, uint16_t *uyvy, int64_t width);
void upipe_v210_to_uyvy_aligned_avx2 (const uint32_t *src, uint16_t *uyvy, int64_t width);
void upipe_v210_to_uyvy_unaligned_ssse3(const uint32_t *src, uint16_t *uyvy, int64_t width);
void upipe_v210_to_uyvy_unaligned_avx  (const uint32_t *src, uint16_t *uyvy, int64_t width);
void upipe_v210_to_uyvy_unaligned_avx2 (const uint32_t *src, uint16_t *uyvy, int64_t width);
