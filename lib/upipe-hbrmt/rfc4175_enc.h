...
/* process (6*mmsize)/16 pixels per iteration */
void upipe_v210_to_sdi_ssse3(uint32_t *src, uint8_t *dst, int64_t pixels);
void upipe_v210_to_sdi_avx  (uint32_t *src, uint8_t *dst, int64_t pixels);
void upipe_v210_to_sdi_avx2 (uint32_t *src, uint8_t *dst, int64_t pixels);
