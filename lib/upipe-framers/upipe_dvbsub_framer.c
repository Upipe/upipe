 ...
 */
static enum ubase_err upipe_dvbsubf_set_flow_def(struct upipe *upipe,
                                               struct uref *flow_def)
{
    if (flow_def == NULL)
 ...
 * @return an error code
 */
static enum ubase_err upipe_dvbsubf_control(struct upipe *upipe,
                                          ...
                                          va_list args)
{
    switch (command) {
        ...
        case UPIPE_GET_OUTPUT: {
            ...
            return upipe_dvbsubf_get_output(upipe, p);
        }
        case UPIPE_SET_OUTPUT: {
            struct upipe *output = va_arg(args, struct upipe *);
            return upipe_dvbsubf_set_output(upipe, output);
        }
        default:
