                                         ...
                                         int command, va_list args)
{
    switch (command) {
        case UPIPE_GET_FLOW_DEF: {
            ...
            return upipe_ts_scte104d_sub_get_flow_def(upipe, p);
        }
        case UPIPE_GET_OUTPUT: {
            struct upipe **p = va_arg(args, struct upipe **);
            return upipe_ts_scte104d_sub_get_output(upipe, p);
        }
        case UPIPE_SET_OUTPUT: {
            struct upipe *output = va_arg(args, struct upipe *);
            return upipe_ts_scte104d_sub_set_output(upipe, output);
        }
        case UPIPE_SUB_GET_SUPER: {
            struct upipe **p = va_arg(args, struct upipe **);
            return upipe_ts_scte104d_sub_get_super(upipe, p);
        }
                                     ...
                                     int command, va_list args)
{
    switch (command) {
        ...
        case UPIPE_GET_SUB_MGR: {
            ...
            return upipe_ts_scte104d_get_sub_mgr(upipe, p);
        }
        case UPIPE_ITERATE_SUB: {
            struct upipe **p = va_arg(args, struct upipe **);
            return upipe_ts_scte104d_iterate_sub(upipe, p);
        }
